...
That gives you a table shaped like this (with **your own measured numbers**, not the placeholders below — actual values depend entirely on your CPU, RAM, and installed library versions):
...
This tutorial's written explanations,  were drafted with the assistance of Ai, based on a description of the project's requirements. Specifically, AI assistance was used to:
...
I started my journey with the Qiskit global summer school 2020 and it was a good experience overall 
